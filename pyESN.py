...
class ESN():
    ...
    def __init__(self, n_inputs, n_outputs, n_reservoir=200,
                 spectral_radius=0.95, sparsity=0, noise=0, teacher_forcing=True,
                 input_shift=None, input_scaling=None,
                 teacher_scaling=None, teacher_shift=None, feedback_scaling=None,
    ...
    def _update(self, state, input_pattern, output_pattern):
        ...
        if self.teacher_forcing:
            preactivation = (np.dot(self.W, state)
                             ...
                             + np.dot(np.dot(self.W_feedb, np.diag(self.feedback_scaling)), output_pattern))
        else:
            preactivation = (np.dot(self.W, state)
                             + np.dot(self.W_in, input_pattern))
    ...
    def fit(self, inputs, outputs, nForgetPoints, inspect=False):
        """
